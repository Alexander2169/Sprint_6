class TestData:
    test_data_user_1 = ['Самокат', 'Самокатов', 'Самокатная, д. 7', 'Чистые Пруды', '+77777777777', '17.09.2024',
                 ')))']

    test_data_user_2 = ['Самоката', 'Самокатова', 'Несамокатная, д. 5', 'Красные Ворота', '+75555555555', '27.09.2024',
                 '(((']
